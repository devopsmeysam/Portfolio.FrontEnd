...
export class RestDataSource {
    ...
    insertInventory(item: Inventory): Observable<Inventory> {
        console.log("The Item Created Successfully!");
    ...
    deleteInventory(id: string): Observable<ResponseModel> {
        return this.http.delete<ResponseModel>(`${this.baseUrl}inventory/delete/${id}`, this.provideToken()).pipe(map(response => {return response;}),
        catchError(error => {return of(error.error)}));
    }
